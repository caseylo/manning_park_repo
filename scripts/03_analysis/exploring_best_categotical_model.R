...
model_data_conf <- read_csv("data/processed/model_data_conf.csv")
model_data_medhigh_conf <- read_csv("data/processed/model_data_medhigh_conf.csv")

# No data in this dataset
#model_data_high_conf <- read_csv("data/processed/model_data_high_conf.csv")
...
png("outputs/figures/model_outliers.png", width = 15, height = 6, units = "in", res = 300)
plot(sim_res)
dev.off()
...
ggsave("outputs/figures/bestmod_elevation_curve.png",plot = bestmod_plot, width = 7, height = 4, dpi = 300)
...
ggsave("outputs/figures/bestmod_fg_elevation_curve.png", plot = bestmod_fg_plot, width = 11, height = 4.5, dpi = 300)
...
ggsave("outputs/figures/confmod_elevation_curve.png",plot = conf_plot, width = 7, height = 4, dpi = 300)
...
ggsave("outputs/figures/confmod_fg_elevation_curve.png", plot = conf_fg_plot, width = 11, height = 4.5, dpi = 300)
...
ggsave("outputs/figures/medhighmod_elevation_curve.png",plot = medhigh_plot, width = 7, height = 4, dpi = 300)
...
ggsave("outputs/figures/medhighmod_fg_elevation_curve.png", plot = medhigh_fg_plot, width = 11, height = 4.5, dpi = 300)
...
ggsave("outputs/figures/bestmod_elevation_curve_scaled.png",plot = bestmod_plot_scaled, width = 7, height = 4, dpi = 300)
...
## Load PNG
img <- readPNG("outputs/figures/bestmod_elevation_curve_scaled.png")
img2 <- readPNG("outputs/figures/no_error_plot_scaled.png")
...
ggsave("outputs/figures/combined_scaled_plot.png",plot = combined_plot, width = 7, height = 8, dpi = 300)
