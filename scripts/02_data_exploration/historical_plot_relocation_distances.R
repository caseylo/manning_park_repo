#### Calculating the distance between historical plot lat/long and 2025 resurveys
...
## Read data
data_long <- read_csv("data/processed/model_data.csv")
#data_long <- read_csv("data/processed/model_data_filt.csv")
