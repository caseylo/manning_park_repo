...
BEC_data <- read_csv("data/processed/BEC_clean.csv")
data_2025 <- read_csv("data/processed/data_2025_clean.csv")
species_names <- read_csv("data/cleaned/master_species_list.csv")
model_data_filt <- read_csv("data/processed/model_data_filt.csv")
...
write.csv(model_data, file = "data/processed/model_data_all_species.csv")
