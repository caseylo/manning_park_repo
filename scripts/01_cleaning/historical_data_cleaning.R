...
BEC_raw <- read_csv("data/raw/Manning_plots_allveg.csv")
...
data_2025 <- read_csv("data/raw/manning_park_resurvey_data.csv")
...
write.csv(species_2025, file = "data/cleaned/cleaning_data/species_2025.csv")
...
write.csv(BEC_species, file = "data/cleaned/cleaning_data/BEC_species.csv")
...
BEC_species_code_and_latin_names <- read.csv("data/raw/BEC_species_code_and_latin_names.csv")
...
write.csv(BEC_clean, file = "data/cleaned/BEC_clean.csv")

## For 2025 data

species_code_and_latin_names_2025 <- read.csv("data/raw/species_code_and_latin_names_2025.csv")
...
write.csv(data_2025, file = "data/cleaned/data_2025_clean.csv")
