...
BEC_clean <- read_csv("data/cleaned/BEC_clean.csv")

data_2025_clean <- read_csv("data/cleaned/data_2025_clean.csv")
...
write.csv(richness_tests, "outputs/tables/richness_tests_table.csv", row.names = FALSE)

write.csv(richness_tests_no_func, "outputs/tables/richness_tests_table_no_func.csv", row.names = FALSE)
...
write.csv(richness_summary_wide, "outputs/tables/richness_summary_table.csv", row.names = FALSE)

write.csv(richness_summary_wide_no_func, "outputs/tables/richness_summary_table_no_func.csv", row.names = FALSE)
