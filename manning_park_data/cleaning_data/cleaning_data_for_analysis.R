...
write.csv(data_2025_long, file = "manning_park_data/ data_2025_long.csv")
...
write.csv(BEC_data_long, file = "manning_park_data/ BEC_data_long.csv")
...
write.csv(model_data, file = "manning_park_data/model_data.csv")
