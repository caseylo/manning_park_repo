...
BEC <- read_csv("manning_park_data/cleaning_data/BEC_species_code_and_latin_names.csv")

data <- read_csv("manning_park_data/cleaning_data/species_code_and_latin_names_2025.csv")
...
## SAVE
write_csv(species_lookup_final,"manning_park_data/cleaning_data/master_species_list.csv")
