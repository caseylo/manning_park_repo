...
BEC_clean <- read_csv("manning_park_data/BEC_select.csv")
species_names <- read_csv("manning_park_data/cleaning_data/master_species_list.csv")
data_2025_clean <- read_csv("manning_park_data/data_2025_select.csv")
...
#write.csv(data_2025_long, file = "manning_park_data/ data_2025_filt_long.csv")
...
#write.csv(BEC_data_long, file = "manning_park_data/ BEC_data_filt_long.csv")
...
#write.csv(model_data, file = "manning_park_data/model_data_filt.csv")

## Save sensitivity data

## High, Med-High, Med confidence only:
#write.csv(model_data, file = "manning_park_data/sensitivity_analysis_data/model_data_conf.csv")

## High, High/Med-High, Med-High confidence only
#write.csv(model_data, file = "manning_park_data/sensitivity_analysis_data/model_data_medhigh_conf.csv")

## High, High/Med-High Confidence only 
#write.csv(model_data, file = "manning_park_data/sensitivity_analysis_data/model_data_high_conf.csv")
