...
## Cleaning daa for relocation error analysis
...
write.csv(data_2025_clean, file = "manning_park_data/data_2025_relocation.csv")
...
write.csv(BEC_clean, file = "manning_park_data/BEC_relocation.csv")
...
write.csv(data_all, file = "manning_park_data/relocation_data_long.csv")
...
write.csv(comm_matrix, file = "manning_park_data/relocation_data_wide.csv")
