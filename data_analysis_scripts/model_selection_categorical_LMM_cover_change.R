#### LMM Cover change FILTERED (Binned 1976 - 2000)
...
AIC <- AIC(cov_mod1_full, cov_mod2_full, cov_mod3_full,cov_mod3.1_full, cov_mod3.2_full,
    ...
    cov_mod8.1_full, cov_mod8.2_full, cov_mod8.3_full, cov_mod9_full,
    cov_mod9.1_full, cov_mod9.2_full, cov_mod9.3_full, cov_mod9.4_full, cov_mod9.5_full)
AIC

#write.csv(AIC, file = "manning_park_data/AICTODELETE.csv")
