...
ggsave("figures/continuous_mod_elevation_curve.png",plot = pred_plot, width = 7, height = 4, dpi = 300)
...
ggsave("figures/continuous_fg_elevation_curve.png", plot = pred_fg_plot, width = 11, height = 4.5, dpi = 300)
