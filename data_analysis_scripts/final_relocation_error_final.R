...
# write.csv(species_occurrence_by_time,
#           "manning_park_data/relocation_error_occurrences.csv",
#           row.names = FALSE)
...
ggsave("figures/2019_combined_plot.png",
       plot = combined_plot,
       width = 11,
       height = 4.5,
       dpi = 300)
...
ggsave("figures/2019_combined_plot_fg.png",
       plot = combined_plot2,
       width = 11,
       height = 8,
       dpi = 300)
...
## resccaling to compare full model with this model:
...
ggsave("figures/no_error_plot_scaled.png", plot = no_error_plot_scaled, width = 7, height = 4, dpi = 300)
